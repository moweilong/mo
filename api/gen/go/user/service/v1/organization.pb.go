...
type Organization struct {
	...
	OrganizationId *uint32                `protobuf:"varint,1,opt,name=organization_id,json=organizationId,proto3,oneof" json:"organization_id,omitempty"` // 组织ID
...
type GetOrganizationRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	OrganizationId uint32                 `protobuf:"varint,1,opt,name=organization_id,json=organizationId,proto3" json:"organization_id,omitempty"` // 组织ID
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_user_service_v1_organization_proto_rawDesc = "" +
	"\n" +
	"\"user/service/v1/organization.proto\x12\x0fuser.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\xa3\a\n" +
	"\fOrganization\x12<\n" +
	"\x0forganization_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b组织IDH\x00R\x0eorganizationId\x88\x01\x01\x12+\n" +
	...
	"\x0forganization_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b组织IDR\x0eorganizationId\"N\n" +
	...
	"\x0e_allow_missing\"T\n" +
	"\x19DeleteOrganizationRequest\x127\n" +
	"\x0forganization_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b组织IDR\x0eorganizationId\"T\n" +
	...
	"\vBatchCreate\x120.user.service.v1.BatchCreateOrganizationsRequest\x1a1.user.service.v1.BatchCreateOrganizationsResponse\"\x00B\xc4\x01\n" +
	"\x13com.user.service.v1B\x11OrganizationProtoP\x01Z<github.com/moweilong/mo/api/gen/go/user/service/v1;servicev1\xa2\x02\x03USX\xaa\x02\x0fUser.Service.V1\xca\x02\x0fUser\\Service\\V1\xe2\x02\x1bUser\\Service\\V1\\GPBMetadata\xea\x02\x11User::Service::V1b\x06proto3"
