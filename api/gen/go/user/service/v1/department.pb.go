...
type Department struct {
	...
	DepartmentId     *uint32                `protobuf:"varint,1,opt,name=department_id,json=departmentId,proto3,oneof" json:"department_id,omitempty"`            // 部门ID
...
func (x *Department) GetDepartmentId() uint32 {
...
type GetDepartmentRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DepartmentId  uint32                 `protobuf:"varint,1,opt,name=department_id,json=departmentId,proto3" json:"department_id,omitempty"` // 部门ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_service_v1_department_proto_rawDesc = "" +
	"\n" +
	" user/service/v1/department.proto\x12\x0fuser.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\xd3\b\n" +
	"\n" +
	"Department\x128\n" +
	"\rdepartment_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b部门IDH\x00R\fdepartmentId\x88\x01\x01\x12+\n" +
	...
	"\x14GetDepartmentRequest\x123\n" +
	"\rdepartment_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b部门IDR\fdepartmentId\"J\n" +
	...
	"\x0e_allow_missing\"N\n" +
	"\x17DeleteDepartmentRequest\x123\n" +
	"\rdepartment_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b部门IDR\fdepartmentId\"P\n" +
	...
	"\vBatchCreate\x12..user.service.v1.BatchCreateDepartmentsRequest\x1a/.user.service.v1.BatchCreateDepartmentsResponse\"\x00B\xc2\x01\n" +
	"\x13com.user.service.v1B\x0fDepartmentProtoP\x01Z<github.com/moweilong/mo/api/gen/go/user/service/v1;servicev1\xa2\x02\x03USX\xaa\x02\x0fUser.Service.V1\xca\x02\x0fUser\\Service\\V1\xe2\x02\x1bUser\\Service\\V1\\GPBMetadata\xea\x02\x11User::Service::V1b\x06proto3"
