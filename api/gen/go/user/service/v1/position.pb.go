...
type Position struct {
	...
	PositionId    *uint32                `protobuf:"varint,1,opt,name=position_id,json=positionId,proto3,oneof" json:"position_id,omitempty"`  // 职位ID
...
type GetPositionRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PositionId    uint32                 `protobuf:"varint,1,opt,name=position_id,json=positionId,proto3" json:"position_id,omitempty"` // 职位ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetPositionRequest) GetPositionId() uint32 {
	if x != nil {
		return x.PositionId
	}
	return 0
...
func (x *DeletePositionRequest) GetPositionId() uint32 {
	if x != nil {
		return x.PositionId
	}
	return 0
...
const file_user_service_v1_position_proto_rawDesc = "" +
	"\n" +
	"\x1euser/service/v1/position.proto\x12\x0fuser.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\xc2\a\n" +
	"\bPosition\x124\n" +
	"\vposition_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b职位IDH\x00R\n" +
	...
	"\x05total\x18\x02 \x01(\rR\x05total\"E\n" +
	"\x12GetPositionRequest\x12/\n" +
	"\vposition_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b职位IDR\n" +
	"positionId\"F\n" +
	...
	"\vBatchCreate\x12,.user.service.v1.BatchCreatePositionsRequest\x1a-.user.service.v1.BatchCreatePositionsResponse\"\x00B\xc0\x01\n" +
	"\x13com.user.service.v1B\rPositionProtoP\x01Z<github.com/moweilong/mo/api/gen/go/user/service/v1;servicev1\xa2\x02\x03USX\xaa\x02\x0fUser.Service.V1\xca\x02\x0fUser\\Service\\V1\xe2\x02\x1bUser\\Service\\V1\\GPBMetadata\xea\x02\x11User::Service::V1b\x06proto3"
