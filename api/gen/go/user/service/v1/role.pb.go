...
type Role struct {
	...
	RoleId        *uint32                `protobuf:"varint,1,opt,name=role_id,json=roleId,proto3,oneof" json:"role_id,omitempty"`              // 角色ID
...
const file_user_service_v1_role_proto_rawDesc = "" +
	"\n" +
	"\x1auser/service/v1/role.proto\x12\x0fuser.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\x8f\b\n" +
	"\x04Role\x12,\n" +
	"\arole_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b角色IDH\x00R\x06roleId\x88\x01\x01\x12+\n" +
	...
	"\arole_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b角色IDR\x06roleId\">\n" +
	...
	"\arole_id\x18\x01 \x01(\rB\x0e\xbaG\v\x92\x02\b角色IDR\x06roleId\"D\n" +
	...
	"\vBatchCreate\x12(.user.service.v1.BatchCreateRolesRequest\x1a).user.service.v1.BatchCreateRolesResponse\"\x00B\xbc\x01\n" +
	"\x13com.user.service.v1B\tRoleProtoP\x01Z<github.com/moweilong/mo/api/gen/go/user/service/v1;servicev1\xa2\x02\x03USX\xaa\x02\x0fUser.Service.V1\xca\x02\x0fUser\\Service\\V1\xe2\x02\x1bUser\\Service\\V1\\GPBMetadata\xea\x02\x11User::Service::V1b\x06proto3"
