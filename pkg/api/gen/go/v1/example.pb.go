...
const file_v1_example_proto_rawDesc = "" +
	"\n" +
	"\x10v1/example.proto\x12\x02v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbc\x03\n" +
	...
	"\n" +
	"\x06Banned\x10\x02Bi\n" +
	"\x06com.v1B\fExampleProtoP\x01Z)github.com/moweilong/mo/pkg/api/gen/go/v1\xa2\x02\x03VXX\xaa\x02\x02V1\xca\x02\x02V1\xe2\x02\x0eV1\\GPBMetadata\xea\x02\x02V1b\x06proto3"
...
func file_v1_example_proto_init() {
	...
	file_v1_example_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
